...
#
#  $Revision: 1.15 $
#  $Id: Wx.pm,v 1.15 2004/09/06 20:11:31 hongli Exp $
#
#########################################################################
...
sub errorDialog {
	...
	Wx::MessageBox($msg, "$title - openKore", wxICON_ERROR, $self->{frame});
}
...
sub createInterface {
	...
	### Main window
	my $frame = $self->{frame} = new Wx::Frame(undef, -1, "openKore");
